...
typedef unsigned int AESWORD;             // 32-bit AESWORD, change to "long" for 16-bit machines
...
int aes_encrypt_ccm(const BYTE plaintext[],              // IN  - Plaintext.
                    AESWORD plaintext_len,                  // IN  - Plaintext length.
                    ...
                    AESWORD *ciphertext_len,                // OUT - The length of the ciphertext, always plaintext_len + mac_len.
                    AESWORD mac_len,                        // IN  - The desired length of the MAC, must be 4, 6, 8, 10, 12, 14, or 16.
...
int aes_decrypt_ccm(const BYTE ciphertext[],             // IN  - Ciphertext, the concatination of encrypted plaintext and MAC.
                    AESWORD ciphertext_len,                 // IN  - Ciphertext length in bytes.
                    ...
                    AESWORD *plaintext_len,                 // OUT - Length in bytes of the output plaintext, always ciphertext_len - mac_len .
                    AESWORD mac_len,                        // IN  - The length of the MAC that was calculated.
